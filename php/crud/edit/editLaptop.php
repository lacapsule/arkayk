...
if($_POST){
    ...
    && isset($_POST['etat']) && !empty($_POST['etat'])){
        ...
        $sql = 'UPDATE `laptop` SET `date`=:date, `serial`=:serial, `marque`=:marque, `modele`=:modele, `etat`=:etat, WHERE `id`=:id;';
...
<body>
    ...
    <aside>
    <a href="editLaptop.php"><img src="../../../img/edit.png" alt="retour à l'ajout d'écran"></a>

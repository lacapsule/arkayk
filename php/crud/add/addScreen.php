...
if($_POST){
    ...
    && isset($_POST['etat']) && !empty($_POST['etat'])){
        ...
        $sql = 'INSERT INTO `screen` (`date`, `serial`, `marque`, `modele`, `etat`) VALUES (:produit, :prix, :nombre);';
        ...
        header('Location: ../crudScreen.php');
    }else{
...
<body>
<aside>
    <a href="../formScreen.php"><img src="../../../img/Screen.png" alt="Ajouter une unité centrale"></a>
    ...
    <input class="col-14" type="text" name="serial" placeholder="Numéro de série de l'Screen" required pattern="^[A-Z *|* 0-9]{8,14}$" onBlur="this.value = this.value.toUpperCase()" onblur="this.placeholder= 'Vous n\'avez pas terminé la saisie'" required/><hr/>

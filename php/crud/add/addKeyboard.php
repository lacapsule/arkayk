...
if($_POST){
    ...
    && isset($_POST['etat']) && !empty($_POST['etat'])){
        ...
        $sql = 'INSERT INTO `keyboard` (`date`, `serial`, `marque`, `modele`, `etat`) VALUES (:produit, :prix, :nombre);';
...
<html lang="fr">
<head>
<title> Ajouter un clavier </title>
    <link rel="icon" type="image/bmp" href="../../../img/keyboard.bmp"/>
    <link rel="stylesheet" type="text/css" href="../../../css/form.css">
</head>
<body>
<aside>
    <a href="../formKeyboard.php"><img src="../../../img/Keyboard.png" alt="Ajouter une unité centrale"></a>
    ...
    <input class="col-14" type="text" name="serial" placeholder="Numéro de série de l'Keyboard" required pattern="^[A-Z *|* 0-9]{8,14}$" onBlur="this.value = this.value.toUpperCase()" onblur="this.placeholder= 'Vous n\'avez pas terminé la saisie'" required/><hr/>

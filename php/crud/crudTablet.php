...
$sql = 'SELECT * FROM tablet ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formTablet.php"><img src="../../img/tablet.png" alt="retour à l'ajout de tablette"></a>
    <a href="crudTablet.php"><img src="../../img/crud.svg" alt="Modifier/Ajouter par lot"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addTablet.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editTablet.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deleteTablet.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>

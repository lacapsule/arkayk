...
$sql = 'SELECT * FROM print ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formPrint.php"><img src="../../img/print.png" alt="retour à l'ajout d'écran"></a>
    <a href="crudPrint.php"><img src="../../img/crud.svg" alt="Modifier/Ajouter par lot"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addPrint.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editPrint.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deletePrint.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>

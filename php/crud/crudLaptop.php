...
$sql = 'SELECT * FROM laptop ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formLaptop.php"><img src="../../img/laptop.png" alt="retour à l'ajout de laptop"></a>
    <a href="crudLaptop.php"><img src="../../img/crud.svg" alt="Modifier/Ajouter par lot"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addLaptop.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editLaptop.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deleteLaptop.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>

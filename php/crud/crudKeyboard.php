...
$sql = 'SELECT * FROM keyboard ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formKeyboard.php"><img src="../../img/keyboard.png" alt="retour à l'ajout de clavier"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addKeyboard.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editKeyboard.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deleteKeyboard.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>

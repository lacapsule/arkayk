...
$sql = 'SELECT * FROM screen ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formScreen.php"><img src="../../img/screen.png" alt="retour à l'ajout d'écran"></a>
    <a href="../home.php"><img src="../../img/home.svg" alt="Revenir à l'accueil"></a>
    <a href="crudScreen.php"><img src="../../img/crud.svg" alt="Modifier/Ajouter par lot"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addScreen.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editScreen.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deleteScreen.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>

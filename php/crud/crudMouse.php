...
$sql = 'SELECT * FROM mouse ORDER BY id DESC LIMIT 0,9';
...
<body>
    ...
    <aside>
    <a href="../forms/formMouse.php"><img src="../../img/mouse.png" alt="retour à l'ajout de souris"></a>
    <a href="crudMouse.php"><img src="../../img/crud.svg" alt="Modifier/Ajouter par lot"></a>
...
<div id="main">
  <table class="container">
    ...
    <a href="add/addMouse.php?id=<?= $resultat['id'] ?>"><button id="new"></button></a>
    <a href="edit/editMouse.php?id=<?= $resultat['id'] ?>"><button id="edit"></button></a>
    <a href="delete/deleteMouse.php?id=<?= $resultat['id'] ?>"><button id="del"></button></a>
